...
#define cpu_map_h
  ...
  #define PROBE_MASK      (1<<PROBE_BIT)
    ...
    #define SPINDLE_TCCRB_INIT_MASK      1<<CS20 | 1<<CS21 |1<<CS22;    // set prescaler to 1024 -> 61Hz Added Servo Support
    // M5 to lock servo motion = will retain stored value in memory
    // M3 will unlock servo motion = apply the last stored servo value state to the servo (S30, S90).
    // S30, S90 - Servo Up or Down u decide
